...
public class Activity_CreateTask extends AppCompatActivity implements View.OnClickListener {

    EditText edt_title,edt_reason;
    TextView txt_startdeadline,txt_enddeadline,txt_status, txt_frequency,txt_frequency_value,txt_start_time,txt_end_time;
    ImageView btn_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__create_task);
    ...
    void Findids(){
        ...
        txt_frequency_value=findViewById(R.id.txt_frequncy_value);
       ...
       // txt_status.setOnClickListener(this);
        ...
        //edt_title.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_FLAG_CAP_WORDS);
    }
    ...
    void action_startdeadline(){
        ...
        try {
            ...
            DatePickerDialog datePickerDialog = new DatePickerDialog(Activity_CreateTask.this, new DatePickerDialog.OnDateSetListener() {
                @Override
    ...
    void action_weekly(){
        ...
        final Dialog dialogbox_weekly = new Dialog(Activity_CreateTask.this);
    ...
    private void show_dialogbox_frequency() {
        ...
        final Dialog dialogbox_type = new Dialog(Activity_CreateTask.this);
    ...
    public String return_monthname(int month){
        String monthname="";
         if(month==1){
             monthname="Jan";
         }else if(month==2){
